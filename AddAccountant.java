...
public class AddAccountant extends JFrame implements ActionListener
{
    ...
    AddAccountant()
    {
        ...
        ImageIcon i = new ImageIcon("D:\\College\\Projects\\Fee_Report_APP\\Media\\AddAccountent.png");
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==b1)
        {
            ...
            try
            {
                ...
                String q = "insert into accountant  (Name,Password, Email, Contact, Address) values ('"+name+"','"+pass+"','"+ Email+"','"+ Contact+"','"+Address+"')";
