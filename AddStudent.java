...
public class AddStudent extends JFrame implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        if(e.getSource()==b1)
        {
            ...
            long cont = Long.parseLong(t11.getText());
            ...
            if(e.getSource()==b1)
            {
                ...
                String q = "insert into addstudent (Name, Email, Course, Fee, Paid, Due, Address, City, State, Country,Contact) values ('"+name+"','"+Email+"','"+Course+"','"+fee+"','"+paid+"','"+due+"','"+Address+"','"+ city+"','"+ state+"','"+country+"','"+ cont+"')";
